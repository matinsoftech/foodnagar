...
//Reports
use App\Http\Controllers\Livewire\BlogsController;
use App\Http\Controllers\Livewire\OurPartnerController;
use App\Http\Controllers\Livewire\SubscriptionPackageController;
use App\Http\Controllers\Livewire\FeatureProductController;
use App\Http\Controllers\Livewire\BrandController;
...
use App\Http\Controllers\Livewire\AmenityController;
...
use App\Http\Controllers\Livewire\ChattingController;
use App\Http\Livewire\Report\CommissionReportLivewire;
use App\Http\Controllers\Livewire\ProductFaqController;
use App\Http\Livewire\Payment\PaymentProcessedLivewire;

use App\Http\Livewire\PaymentMethodVehicleTypeLivewire;
use App\Http\Controllers\Livewire\CustomFieldController;
use App\Http\Controllers\Livewire\TestinomialController;
...
use App\Http\Controllers\Livewire\SubSubCatgoryController;
use App\Http\Livewire\Payment\WalletTopUpCallbackLivewire;
use App\Http\Controllers\Livewire\WebsiteSettingController;
...
Route::group(['middleware' => ['web']], function () {
    ...
    */
    ...
    Route::group(['middleware' => ['auth', 'restrict_roles:client,driver', "user.active.check"]], function () {
        ...
        Route::get('product/products', ProductLivewire::class)->name('admin.products');
        Route::get('products/bulk-upload', [ProductLivewire::class, 'showForm'])->name('admin.products.bulk-upload.form');
        Route::post('products/bulk-upload', [ProductLivewire::class, 'upload'])->name('admin.products.bulk-upload');

        Route::get('product/details/{id}', ProductDetailsLivewire::class)->name('product.details');
        Route::get('product/faqs/{id}/create',[ProductFaqController::class,'create'])->name('product.faq.create');
        Route::post('product/faqs/{id}/store',[ProductFaqController::class , 'store' ])->name('product.faq.store');
        Route::delete('product/faqs/{id}/destroy',[ProductFaqController::class , 'destroy' ])->name('product.faq.destroy');
        ...
        //services
        Route::get('service/services', ServiceLivewire::class)->name('admin.services');
        ...
        Route::get('order/success', OrderLivewire::class)->name('order.success');
        ...
        Route::group(['middleware' => ['role:admin']], function () {
            ...
            Route::prefix('setting')->group(function () {
                Route::resource('website_settings', WebsiteSettingController::class);
            });
            ...
            //New Partner
            Route::get('our-partners',[OurPartnerController::class,'index'])->name('our_partners.index');
            Route::delete('our-partners/{id}', [OurPartnerController::class, 'destroy'])->name('our_partners.destroy');

            //Delivery Subscription Package
            Route::resource('subscription', SubscriptionPackageController::class);

            //Delivery Subscription Purchase
            Route::get('subscription-purchases',[SubscriptionPackageController::class,'purchaseIndex'])->name('subscription_purchases.purchase_index');
            Route::post('subscription-purchases/{purchase}/status', [SubscriptionPackageController::class, 'updatePurchaseStatus'])->name('subscription_purchases.update_status');

            //Feature Product Section
            Route::get('feature-products', [FeatureProductController::class, 'index'])->name('feature_product.index');
            Route::get('feature-products/add', [FeatureProductController::class, 'create'])->name('feature_product.create');
            Route::post('feature-product/store', [FeatureProductController::class, 'store'])->name('feature_product.store');
            Route::get('feature-product/show/{id}', [FeatureProductController::class, 'show'])->name('feature_product.show');
            Route::get('feature-product/edit/{id}', [FeatureProductController::class, 'edit'])->name('feature_product.edit');
            Route::put('feature-product/update/{id}', [FeatureProductController::class, 'update'])->name('feature_product.update');
            Route::delete('feature-product/destroy/{id}', [FeatureProductController::class, 'destroy'])->name('feature_product.destroy');


            // subsubcategory
            Route::prefix('categories/subsubcategory')->name('subsubcategory.')->group(function () {
                Route::get('/', [SubSubCatgoryController::class, 'index'])->name('index');
                Route::get('create', [SubSubCatgoryController::class, 'create'])->name('create');
                Route::post('store', [SubSubCatgoryController::class, 'store'])->name('store');
                Route::get('show/{id}', [SubSubCatgoryController::class, 'show'])->name('show');
                Route::get('edit/{id}', [SubSubCatgoryController::class, 'edit'])->name('edit');
                Route::put('update/{id}', [SubSubCatgoryController::class, 'update'])->name('update');
                Route::delete('destroy/{id}', [SubSubCatgoryController::class, 'destroy'])->name('destroy');
                Route::get('get-subcategories/{id}', [SubSubCatgoryController::class, 'getSubcategories'])->name('get.subcategories');
            });


            Route::resource('brands',BrandController::class);
            Route::resource('testinomial',TestinomialController::class);
    ...
    //Vendor  Message
    Route::get('message',[ChattingController::class,'messages'])->name('message');
    Route::post('send-message',[ChattingController::class,'sendMessage'])->name('send-message');
    Route::post('customer-message', [ChattingController::class, 'CustomerMessage'])->name('CustomerMessage');
});
