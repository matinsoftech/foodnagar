...
use App\Http\Controllers\API\NewPartnerController;
...
Route::get('home',function(){
    $app_module = AppModule::with(['hasvendorType','hasvendor'])
    ->firstOrFail();

   return response()->json(['app_module'=>$app_module]);
});
...
Route::get('feature/products', [BannerController::class, "featureIndex"]);
...
//Partner Route
Route::post('/our-partner', [NewPartnerController::class, 'store']);
...
Route::get('subscription',[SubscriptionController::class,'getSubscriptionPackages']);
...
Route::group(['middleware' => ['auth:sanctum', "user.active.check"]], function () {
    ...
    Route::post('device/latlong',[UserFirebaseController::class,'updateLatLong']);
    Route::post('device/available',[UserFirebaseController::class,'setAvailable']);
    ...
    Route::get('chatlist', [ChatNotificationController::class, 'chatList']);
    Route::get('chat/messages', [ChatNotificationController::class, 'chatMessages']);
    ...
    Route::post('purchase-subscription/{package}', [SubscriptionController::class, 'purchase']);
    ...
    Route::get('payment-methods', [VendorOrderController::class, 'paymentMethods']);
    Route::get('vendor-customers',[VendorOrderController::class,'vendorCustomers']);
    Route::post('vendor-customers/generate-order', [VendorOrderController::class, 'generateOrder']);
