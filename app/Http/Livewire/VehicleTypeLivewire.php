...
class VehicleTypeLivewire extends BaseLivewireComponent
{
    ...
    // In your VehicleTypeLivewire.php component
    public function resetForm()
    {
        // Reset all the properties to their default state
        $this->reset([
            ...
            'is_active',
                                     ...
                                     // Optionally, if you're using a model for editing, you might want to reset the selected model as well
        $this->selectedModel = null; // or reset it to whatever the initial state should be
    }
