...
class OrderTable extends BaseDataTableComponent
{
    ...
    public function query()
    {
        ...
        $query = $query->when($this->getFilter('payment_method_id'), fn ($query, $paymentMethodId) => $query->where('payment_method_id', $paymentMethodId))
            ...
            ->when($this->getFilter('vendor'), fn ($query, $vendor) => $query->where('vendor_id', $vendor));

        // Apply status filter from parent component if set
