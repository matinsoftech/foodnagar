    ...
    public function signUp()
    {
        $this->validate(
            [
                ...
                "vendor_phone" => "required|numeric|min:10|unique:vendors,phone",
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->to('/verify-phone?user_id=' . $user->id);
            }

            // return redirect()->route()->intended('/verify-phone?phone=' . $this->phone);
