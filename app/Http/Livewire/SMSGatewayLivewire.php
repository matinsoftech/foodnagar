...
class SMSGatewayLivewire extends BaseLivewireComponent
{
    ...
    public function initiateEdit($id)
    {
        ...
        } else if ($this->selectedModel->slug == "sparrow") {
            $this->authkey = env("SPARROW_AUTHKEY");
            $this->sender = env("SPARROW_SENDER");
    ...
    public function update()
    {
        ...
        try {
            ...
            if ($this->selectedModel->slug == "twilio") {
                ...
                $group = "SPARROW";
                setEnv("SPARROW_AUTHKEY", $this->authkey, $group);
                setEnv("SPARROW_SENDER", $this->sender, $group);
