...
class RegularOrderController extends Controller
{
    ...
    public function summary(Request $request)
    {
        ...
        foreach ($request->products ?? [] as $product) {
            ...
            if (!empty($product['selected_variant']) && isset($product['selected_variant']['price'])) {
            ...
            $selectedQty = $product['selected_qty'] ?? 1;
            ...
            if (!empty($product['selected_variant'])) {
                $productData['selected_variant'] = $product['selected_variant'];
            }

            $mProducts[] = $productData;
