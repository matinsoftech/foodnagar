...
class TaxiOrderController extends Controller
{
    ...
    public function book(Request $request)
    {
        ...
        try {
            ...
            $order->delivery_fee = $request->sub_total;
            ...
            $this->driverNotificationService->sendNotificationToDrivers($order);
            //
            DB::commit();
    ...
    public function cancelOrder(Request $request, $id)
    {
        ...
        //
        try {
            $taxiBookingOrder = Order::whereHas('taxi_order')->where('id', $id)->firstOrFail();
