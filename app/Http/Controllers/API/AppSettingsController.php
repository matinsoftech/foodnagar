    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            ...
            "strings" => [
                ...
                'free_first_delivery' => setting('free_first_delivery') == 'on' ? true : false,
                'enable_cart_on_layout' => setting('enable_cart_on_layout') == 'on' ? true : false,
                'subscription_mode' => setting('subscription_mode') == 'on' ? true : false,
                //for website
                "website" => [
