...
class GroceryController extends Controller
{
    ...
    // Filter items with associated products
        ...
        // return view('livewire.website.modules.ecommerce.index',compact('banners','categories','products','few_products','latest_products','categories_products','flashSales','vendor_name'));
