...
class VendorType extends BaseModel
{
    ...
    protected $fillable = ['name', 'description','base_url', 'slug', 'is_active', 'color'];
    ...
    public static function get_vendor_types(Request $request){
        return  VendorType::where('is_active',1)->get();
     }
}
