...
class Order extends BaseModel
{
    ...
    protected $fillable = ["note", "reason", "payment_method_id", "code", "sub_total", "total", "vendor_id", "user_id", "payment_method_id", "delivery_address_id", "delivery_fee"];
