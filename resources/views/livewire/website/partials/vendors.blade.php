                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-4">
                            ...
                            <h6>
                                We have
                                <span class="text-primary">{{ $vendors->count() }}</span>
                                vendors now
                            </h6>
                        </div>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ route('shop.detail', $vendor->id) }}" class="text-inherit">{{ $vendor->name }}</a></h5>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
                    <div class="col">
                        <div class="card flex-row p-8 card-product">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('css/assets/images/stores-logo/stores-logo-4.svg') }}" alt=""
                                    class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ url('shopView') }}" class="text-inherit">Blinkit Store</a></h5>
                                <div class="small text-muted">
                                    <span>Meal Kits</span>
                                    <span class="mx-1">
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('css/assets/images/stores-logo/stores-logo-5.svg') }}" alt=""
                                    class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ url('shopView') }}" class="text-inherit">StoreFront Super Market</a>
                                </h5>
                                <div class="small text-muted">
                                    <span>Groceries</span>
                                    <span class="mx-1">
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('css/assets/images/stores-logo/stores-logo-6.svg') }}" alt=""
                                    class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ url('shopView') }}" class="text-inherit">BigBasket</a></h5>
                                <div class="small text-muted">
                                    <span>Groceries</span>
                                    <span class="mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="4" height="4"
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('css/assets/images/stores-logo/stores-logo-7.svg') }}" alt=""
                                    class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ url('shopView') }}" class="text-inherit">Swiggy Instamart</a></h5>
                                <div class="small text-muted">
                                    <span>Meal Kits</span>
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('css/assets/images/stores-logo/stores-logo-8.svg') }}" alt=""
                                    class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ url('shopView') }}" class="text-inherit">Online Grocery Mart</a></h5>
                                <div class="small text-muted">
                                    <span>Groceries</span>
                                    <span class="mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="4" height="4"
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('css/assets/images/stores-logo/stores-logo-9.svg') }}" alt=""
                                    class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                                <h5 class="mb-1"><a href="{{ url('shopView') }}" class="text-inherit">Spencers</a></h5>
                                <div class="small text-muted">
                                    <span>Groceries</span>
                                    <span class="mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="4" height="4"
