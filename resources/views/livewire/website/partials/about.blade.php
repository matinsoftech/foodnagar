...
@section('content')
    ...
    <main>
                        ...
                        <div class="row align-items-center mb-14">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    ...
                                    <img src="{{ asset('css/assets/images/about/about-img.jpg') }}" alt=""
                                ...
                                <div class="card bg-light mb-6 border-0">
                                    ...
                                    <div class="card-body p-8">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <img src="{{ asset('css/assets/images/about/about-icons-1.svg') }}"
                                        ...
                                        <a href="#" class="btn bg_primary text-white mt-2">FreshCart Platform</a>
                                ...
                                <div class="card bg-light mb-6 border-0">
                                    ...
                                    <div class="card-body p-8">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <img src="{{ asset('css/assets/images/about/about-icons-2.svg') }}"
                                        ...
                                        <a href="#" class="btn bg_primary text-white mt-2">FreshCart ads</a>
                                ...
                                <div class="card bg-light mb-6 border-0">
                                    ...
                                    <div class="card-body p-8">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <img src="{{ asset('css/assets/images/about/about-icons-3.svg') }}"
                                        ...
                                        <a href="#" class="btn bg_primary text-white mt-2">Learn More</a>
        ...
        <section class="bg_primary py-14">
                ...
                <div class="team-slider owl-carousel">
                    ...
                    <div class="item">
                        ...
                        <div class="bg-light rounded">
                            ...
                            <img src="{{ asset('css/assets/images/about/team-1.png') }}" alt="" class="img-fluid" />
                    ...
                    <div class="item">
                        ...
                        <div class="bg-light rounded">
                            ...
                            <img src="{{ asset('css/assets/images/about/team-2.png') }}" alt="" class="img-fluid" />
                    ...
                    <div class="item">
                        ...
                        <div class="bg-light rounded">
                            ...
                            <img src="{{ asset('css/assets/images/about/team-3.png') }}" alt="" class="img-fluid" />
                    ...
                    <div class="item">
                        ...
                        <div class="bg-light rounded">
                            ...
                            <img src="{{ asset('css/assets/images/about/team-4.png') }}" alt="" class="img-fluid" />
                    ...
                    <div class="item">
                        ...
                        <div class="bg-light rounded">
                            ...
                            <img src="{{ asset('css/assets/images/about/team-5.png') }}" alt="" class="img-fluid" />
