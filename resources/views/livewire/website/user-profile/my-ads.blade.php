                        ...
                        <div class="py-6 p-md-0 p-lg-0">
                            ...
                            <section class="myads-parts">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-12 col-md-6 col-lg-4 col-xl-4 mb-lg-4 mb-lg-4 mb-3">
                                            <div class="product-card m-auto">
                                                <div class="product-media">
                                                    <div class="product-img">
                                                        <img src="{{ asset('css/assets/images/products/product-img-1.jpg') }}"
                                                            alt="product">
                                                    </div>
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <h6 class="product-title">
                                                        <a href="#">Lorem ipsum dolor sit amet consect adipisicing
                                                            elit</a>
                                                    </h6>
                                        ...
                                        <div class="col-sm-12 col-12 col-md-6 col-lg-4 col-xl-4 mb-lg-4 mb-lg-4 mb-3">
                                            <div class="product-card m-auto">
                                                <div class="product-media">
                                                    ...
                                                    <ul class="product-action">
                                                        <li class="view"><i class="fas fa-eye"></i><span>264</span></li>
                                                        <li class="click"><i class="fas fa-mouse"></i><span>134</span>
                                                        </li>
                                                        <li class="rating"><i class="fas fa-star"></i><span>4.5/7</span>
                                                        </li>
                                                    </ul>
