                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item py-5 px-0">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{ asset('css/assets/images/svg-graphics/visa.svg') }}" alt="" />
                                            <!-- text -->
                                            <div class="ms-4">
                                ...
                                <li class="list-group-item px-0 py-5">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{ asset('css/assets/images/svg-graphics/mastercard.svg') }}" alt=""
                                                class="me-3" />
                                            <div>
                                ...
                                <li class="list-group-item px-0 py-5">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{ asset('css/assets/images/svg-graphics/discover.svg') }}" alt=""
                                                class="me-3" />
                                            <div>
                                                <!-- text -->
                                ...
                                <li class="list-group-item px-0 py-5">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{ asset('css/assets/images/svg-graphics/americanexpress.svg') }}" alt=""
                                                class="me-3" />
                                            <!-- text -->
                                            <div>
                                ...
                                <li class="list-group-item px-0 py-5 border-bottom">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{ asset('css/assets/images/svg-graphics/paypal.svg') }}" alt=""
                                                class="me-3" />
                                            <div>
                                                <!-- text -->
                                ...
                                <div class="d-inline-flex">
                                    <div class="form-check me-2">
                                        ...
                                        <label class="form-check-label" for="paymentRadioOne"><img
                                                src="{{ asset('css/assets/images/payment/american-express.svg') }}"
                                                alt="" /></label>
                                    </div>
                                    <!-- Radio button -->
                                    <div class="form-check me-2">
                                        ...
                                        <label class="form-check-label" for="paymentRadioTwo"><img
                                                src="{{ asset('css/assets/images/payment/mastercard.svg') }}" alt="" /></label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="paymentRadioFour"><img
                                                src="{{ asset('css/assets/images/payment/visa.svg') }}" alt="" /></label>
                                    </div>
                                </div>
                            </div>
                            <!-- Name on card -->
