                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="single-content">
                            <h2>ad details right</h2>
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                <li class="breadcrumb-item"><a href="{{ url('ad-list') }}">ad-column3</a></li>
                                <li class="breadcrumb-item active" aria-current="page">ad-details-right</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="common-card">
                            ...
                            <div class="ad-details-slider-group">
                                <div class="ad-details-slider owl-carousel slider-arrow">
                                    <div><img src="{{ asset('css/assets/images/listing/product/01.jpg') }}" alt="details">
                                    </div>
                                    <div><img src="{{ asset('css/assets/images/listing/product/02.jpg') }}" alt="details">
                                    </div>
                                    <div><img src="{{ asset('css/assets/images/listing/product/03.jpg') }}" alt="details">
                                    </div>
                                    <div><img src="{{ asset('css/assets/images/listing/product/04.jpg') }}" alt="details">
                                    </div>
                                </div>
                            ...
                            <div class="ad-thumb-slider owl-carousel">
                                <div data-index="0"><img src="{{ asset('css/assets/images/listing/product/01.jpg') }}"
                                        alt="details"></div>
                                <div data-index="1"><img src="{{ asset('css/assets/images/listing/product/02.jpg') }}"
                                        alt="details"></div>
                                <div data-index="2"><img src="{{ asset('css/assets/images/listing/product/03.jpg') }}"
                                        alt="details"></div>
                                <div data-index="3"><img src="{{ asset('css/assets/images/listing/product/04.jpg') }}"
                                        alt="details"></div>
                            </div>
                            ...
                            <div class="ad-details-feature slider-arrow">
                                <div class="feature-card">
                                    <a href="#" class="feature-img">
                                        <img src="{{ asset('css/assets/images/listing/product/10.jpg') }}"
                                            alt="feature">
                                    </a>
                                ...
                                <div class="feature-card">
                                    <a href="#" class="feature-img">
                                        <img src="{{ asset('css/assets/images/listing/product/01.jpg') }}"
                                            alt="feature">
                                    </a>
                                    <div class="cross-inline-badge feature-badge">
                                        <span>featured</span>
                                ...
                                <div class="feature-card">
                                    <a href="#" class="feature-img">
                                        <img src="{{ asset('css/assets/images/listing/product/08.jpg') }}"
                                            alt="feature">
                                    </a>
                                    <div class="cross-inline-badge feature-badge">
                                        <span>featured</span>
