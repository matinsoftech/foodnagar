@if(!empty($few_products) && is_countable($few_products) && count($few_products) > 0)
<section class="my-lg-14 my-8">
    <div class="container">
        <div class="row">
            <div class="col-8 mb-6">
                <h3 class="mb-0">Feature Products</h3>
            </div>
        ...
        <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3">
            @foreach ($few_products as $product)
                        ...
                        <div class="text-center position-relative">
                            ...
                            <div class="card-product-action">
                                ...
                                <a href="javascript:void(0)" class="btn-action add_favourite " data-bs-toggle="tooltip"
                                    data-bs-html="true" title="Saved items" data-id={{$product->id}}>
                            ...
                            <div class="text-small mb-1">
                                @if($vendor_name === 'Home Services')
                                        <a href="{{route('product_details',$product->id)}}" class="text-decoration-none text-muted"><small>
