...
<section class="my-lg-14 my-8">
    <div class="container">
        <div class="col-12 mb-6">
          <u> <h3 class="text-center">Category Wise Products</h3></u>
        </div>
        @foreach ($categories_products as $categoryName => $products)
            <div class="category-section mb-3">
                <div class="row">
                    ...
                    <div class="col-4 mb-6 text-end">
                        <a href="{{ url()->current() }}/products?category={{ $categoryName }}">View All</a>
                    </div>
                </div>
