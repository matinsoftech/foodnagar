    ...
    <div class="card card-product">
        <div class="card-body">
            <div class="text-center position-relative">
                ...
                <a href="#!"><img src="{{ asset('css/assets/images/products/product-img-1.jpg') }}"
            ...
            <h2 class="fs-6"><a href="pages/shop-single.html" class="text-inherit text-decoration-none">Haldiram's Sev
                    Bhujia</a></h2>
            <div>
