...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/assets/css/welcome.css') }}">
@endsection
...
@section('content')
    ...
    <main>
        <section class="mt-8">
            <div class="container">
                ...
                <div class="hero-main-banner owl-carousel owl-theme">
                    <div class="item">
                        <img src="{{ asset('css/assets/images/slider/slide-1.jpg') }}" alt="">
                    </div>
                    <div class="item">
                        <img src="{{ asset('css/assets/images/slider/slider-2.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 mb-3 mb-lg-0">
                        <div>
                            <div class="py-10 px-8 rounded"
                                style="background: url('{{ asset('css/assets/images/banner/grocery-banner.png') }}') no-repeat; background-size: cover; background-position: center">
                                <div>
                    ...
                    <div class="col-12 col-md-6">
                        <div>
                            <div class="py-10 px-8 rounded"
                                style="background: url('{{ asset('css/assets/images/banner/grocery-banner-2.jpg') }}') no-repeat; background-size: cover; background-position: center">
                                <div>
                            ...
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-1.jpg') }}"
                                ...
                                <div class="text-small mb-1">
                                    <a href="{{ url('product') }}" class="text-decoration-none text-muted"><small>Snack &
                                            Munchies</small></a>
                                </div>
                                <h2 class="fs-6"><a href="{{ url('product') }}"
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-2.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                                ...
                                <div class="text-small mb-1">
                                    <a href="{{ url('product') }}" class="text-decoration-none text-muted"><small>Bakery
                                            &
                                            Biscuits</small></a>
                                </div>
                                <h2 class="fs-6"><a href="{{ url('product') }}"
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-3.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-4.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-5.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                                ...
                                <div class="text-small mb-1">
                                    <a href="{{ url('product') }}" class="text-decoration-none text-muted"><small>Instant
                                            Food</small></a>
                                </div>
                                <h2 class="fs-6"><a href="{{ url('product') }}"
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-6.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                                ...
                                <div class="text-small mb-1">
                                    <a href="{{ url('product') }}" class="text-decoration-none text-muted"><small>Dairy,
                                            Bread &
                                            Eggs</small></a>
                                </div>
                                <h2 class="fs-6"><a href="{{ url('product') }}"
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-7.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-8.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-9.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <a href="{{ url('product') }}"><img
                                            src="{{ asset('css/assets/images/products/product-img-10.jpg') }}"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="row row-cols-lg-4 row-cols-1 row-cols-md-2 g-4 flex-nowrap">
                        <div class="col">
                            <div class="pt-8 px-6 px-xl-8 rounded"
                                style="background: url('{{ asset('css/assets/images/banner/banner-deal.jpg') }}') no-repeat; background-size: cover; height: 470px">
                                <div>
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        <a href="{{ url('product') }}"><img
                                                src="{{ asset('css/assets/images/products/product-img-11.jpg') }}"
                                                alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        <a href="{{ url('product') }}"><img
                                                src="{{ asset('css/assets/images/products/product-img-12.jpg') }}"
                                                alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                        <div class="card-product-action">
                                            <a href="#!" class="btn-action" data-bs-toggle="modal"
                                                data-bs-target="#quickViewModal">
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        <a href="{{ url('product') }}"><img
                                                src="{{ asset('css/assets/images/products/product-img-13.jpg') }}"
                                                alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                        <div class="card-product-action">
                                            <a href="#!" class="btn-action" data-bs-toggle="modal"
                                                data-bs-target="#quickViewModal">
        ...
        <section class="container">
            <div class="container"
                style="align-items: center; background-color: #662f88; padding: 5%; border-radius: 30px; margin:30px 0">

                <div style="text-align: center;">
                    <h3 style="color: #ffb600;">
                        STEPS
                    </h3>
                    <h2 style="font-size:40px; font-weight: 600; color: #ffffff;">
                        How Service Finder Works
                    </h2>
                </div>
                <div class="Service-Card">

                    <div class="Service-Card-item" style="text-align: center; align-items: center;">

                        <div class="Serv-Number"
                            style="color: #fff;     -webkit-text-fill-color: rgba(0, 0, 0, 0);     -webkit-text-stroke-width: 1px;     -webkit-text-stroke-color: #fff;">
                            01
                        </div>
                        <div>
                            <div class="Img-Serv-Main">

                                <img class="" src="{{ asset('css/assets/images/welcome/1.png') }}" alt=""
                                    class="Img-Serv-Main-img"
                                    style=" width: 50px; vertical-align: middle; object-fit: contain;
                            object-position: center; " />
                            </div>

                            <h3 style="font-size: 20px; font-weight: 600; color: #fff;">Describe Your Task</h3>
                            <p style="color: #fff">This helps us determine which Taskers are best for your job</p>

                        </div>
                    </div>
                    <div class=" Serv-Arrow">
                        <img src="{{ asset('css/assets/images/welcome/arrow-down.png') }}" alt=""
                    ...
                    <div class="Service-Card-item" style="text-align: center; align-items: center;">
                        ...
                        <div>
                            <div class="Img-Serv-Main">
                                ...
                                <img class="" src="{{ asset('css/assets/images/welcome/2.png') }}" alt=""
                                    class="Img-Serv-Main-img"
                                    style=" width: 50px; vertical-align: middle; object-fit: contain;
                            object-position: center; " />
                            </div>
                    ...
                    <div class=" Serv-Arrow">
                        <img src="{{ asset('css/assets/images/welcome/arrow-up.png') }}" alt=""
                            style="width: 100%; vertical-align: middle;" />
                    </div>
                    ...
                    <div class="Service-Card-item" style="text-align: center; align-items: center;">
                        ...
                        <div>
                            <div class="Img-Serv-Main">
                                ...
                                <img class="" src="{{ asset('css/assets/images/welcome/3.png') }}" alt=""
                                    class="Img-Serv-Main-img"
                                    style=" width: 50px; vertical-align: middle; object-fit: contain;
                            object-position: center; " />
                            </div>
                    ...
                    <div class="">
                        <div class="mb-4">
                            <a href="#!">
                                <!-- img -->
                                <div class="img-zoom">
                                    <img src="{{ asset('css/assets/images/blog/blog-img-1.jpg') }}" alt=""
        ...
        <section class="my-lg-14 my-8">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="mb-8 mb-xl-0">
                            <div class="mb-6"><img src="{{ asset('css/assets/images/icons/gift.svg') }}"
                                    alt="" /></div>
