...
@section('content')
@section('title', __('Edit Testinomial'))
<x-baseview title="{{ __('Edit Testinomial') }}" >
    <div class="overflow-x-auto">
        <div class="container mx-auto py-6">
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="{{ route('testinomial.update', $testinomial->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name', $testinomial->name) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="designation" value="{{ old('designation', $testinomial->designation) }}" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
                            placeholder="testinomial Description">{{ old('description', $testinomial->description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center text-sm font-medium text-gray-700">
                            <input type="checkbox" name="is_published" {{ $testinomial->is_active ? 'checked' : '' }}
                                class="form-checkbox text-blue-500 focus:ring-blue-500">
                            <span class="ml-2">Publish this testinomial</span>
                        </label>
                    </div>

                    <!-- Action Buttons -->
                    <div class="flex justify-end mt-4">
                        <a href="{{ route('testinomial.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">
                            Cancel
                        </a>
