        ...
        <div class="grid grid-cols-1 gap-5">
            <div class="">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <select wire:model="verification_type" class="block w-full px-2 border rounded appearance-none bg-grey-lighter text-grey-darker border-grey-lighter">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <select wire:model="subscription_mode" class="block w-full px-2 border rounded appearance-none bg-grey-lighter text-grey-darker border-grey-lighter">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <label for="free_first_delivery">Free first Delivery</label>
                    <select wire:model="free_first_delivery" class="block w-full px-2 border rounded appearance-none bg-grey-lighter text-grey-darker border-grey-lighter">
                        <option value="on">On</option>
                        <option value="off">Off</option>
                    </select>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <label for="enable_cart_on_layout">Enable Cart on layout</label>
                    <select wire:model="enable_cart_on_layout" class="block w-full px-2 border rounded appearance-none bg-grey-lighter text-grey-darker border-grey-lighter">
                        <option value="on">On</option>
                        <option value="off">Off</option>
                    </select>
                </div>
