    ...
    <div>
        ...
        <div x-data="{ open: @entangle('showCreate') }">
            <x-modal-lg confirmText="{{ __('Save') }}" action="save" :clickAway="false">
                ...
                {{-- Vendor Discounts Starts --}}
                <hr class="mt-4" />
                <p class="font-semibold text-lg">Discount Offer</p>

                <div class="grid grid-cols-2 gap-4">

                    <x-input title="Discount Amount" name="discount_value" placeholder="10" />

                    <x-select-plain title="Discount Type" name="discount_type" :options="[
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <x-input type="date" title="Discount From" name="discount_from" />
                    <x-input type="date" title="Discount To" name="discount_to" />
                </div>
                {{-- Vendor Discounts Ends --}}
