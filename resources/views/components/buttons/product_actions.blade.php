<div x-data="{ showMore: false }">
    <div class="flex flex-wrap items-center space-x-2 gap-y-2">
        ...
        <a href="{{ route('product.faq.create', ['id' => $model->id]) }}" target="_blank">
            <x-buttons.plain bgColor="bg-primary-500" title="{{ __('Faqs') }}">
                <x-lineawesome-question-circle class="w-5 h-5" />
            </x-buttons.plain>
        </a>
