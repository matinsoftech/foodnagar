<ul class="mt-6">
    ...
    {{-- Services --}}
    @showService
    {{-- @if($sidebar_filter == 'service')
    <x-group-menu-item routePath="service/*" title="{{ __('Services/Booking') }}" icon="heroicon-o-rss">
        <x-menu-item title="{{ __('Services/Booking') }}" route="admin.services">
