<ul class="mt-6">
    ...
    @can('view-vendor-types')
        {{-- Vendor Types --}}
        {{-- <x-menu-item title="{{ __('Amenities') }}" route="amenities.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item> --}}
        <x-menu-item title="{{ __('Blogs') }}" route="blogs.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item>
        <x-menu-item title="{{ __('Brands') }}" route="brands.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item>
        {{-- <x-menu-item title="{{ __('Custom Fields') }}" route="custom-fields.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item> --}}

        <x-menu-item title="{{ __('Testinomial') }}" route="testinomial.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item>
    @endcan
    <x-hr />
    @hasanyrole('admin')
        <x-menu-item title="{{ __('Our Partners') }}" route="our_partners.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item>
    @endhasanyrole
    @hasanyrole('admin')
        <x-menu-item title="{{ __('Delivery Subscriptions') }}" route="subscription.index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item>
    @endhasanyrole
    @hasanyrole('admin')
        <x-menu-item title="{{ __('Subscription Purchase') }}" route="subscription_purchases.purchase_index">
            <x-heroicon-o-color-swatch class="w-5 h-5" />
        </x-menu-item>
    @endhasanyrole
    {{-- Vendors --}}
    ...
    {{-- <x-menu-item title="{{ __('Listing Enquiries') }}" route="admin.product-enquiry">
    ...
    <x-group-menu-item routePath="product/*" title="{{ __('Products') }}" icon="heroicon-o-archive">
        ...
        <x-menu-item title="{{ __('Products') }}" route="admin.products">
            <x-heroicon-o-archive class="w-5 h-5" />
        </x-menu-item>
    ...
    <x-group-menu-item routePath="service/*" title="{{ __('Hotel Booking') }}" icon="heroicon-o-rss">
        <x-menu-item title="{{ __('Rooms') }}" route="admin.services">
    ...
    {{-- message --}}
    {{-- <x-menu-item title="Message" route="{{ 'admin/'.url('vendor-message') }}">
        <x-heroicon-o-template class="w-5 h-5" />
    </x-menu-item> --}}
    <li class="relative px-6 py-3">
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-200 text-gray-200"
    ...
    <li class="relative px-6 py-3">
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-200 text-gray-200"
            href="{{ url('admin/feature-products') }}">
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke-width="2" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z">
            ...
            <span class="ml-4">Featured Section</span>
        </a>
    ...
    @canany(['view-orders', 'view-refund', 'view-reviews', 'view-delivery-addresses', 'view-coupons'])
        <x-group-menu-item routePath="order/*" title="{{ __('Orders') }}" icon="heroicon-o-shopping-bag">
            ...
            @endcan
            @can('view-orders')
                <x-menu-item title="{{ __('Orders Delivered') }}" route="order.success">
                    <x-heroicon-o-shopping-bag class="w-5 h-5" />
                </x-menu-item>
            @endcan
            @can('view-refund')
    ...
    @can('view-settings')
        <x-group-menu-item routePath="setting/*" title="{{ __('Settings') }}" icon="heroicon-o-cog">
            ...
            <x-menu-item title="{{ __('Website Settings') }}" route="website_settings.index">
                <x-heroicon-o-globe-alt class="w-5 h-5" />
            </x-menu-item>
